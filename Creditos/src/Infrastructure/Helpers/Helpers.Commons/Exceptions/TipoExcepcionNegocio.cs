...
namespace Helpers.Commons.Exceptions
{
    ...
    public enum TipoExcepcionNegocio
    {
        ...
        [Description("El cliente ya esta registrado en la base de datos")]
        ElClienteYaEstaRegistrado = 576,

        [Description("El valor de la cuota no es válido")]
        ValorDeCuotaInvalido = 578,

        [Description("El cliente ya tiene un crédito activo")]
        ElClienteYaTieneUnCreditoActivo = 579
    }
}