...
public class CrearClienteValidation : AbstractValidator<CrearClienteDto>
{
    public CrearClienteValidation()
    {
        ...
        RuleFor(c => c.NumeroDeCedula).NotEmpty().MinimumLength(4).WithMessage("La cedula debe contener almenos 4 digitos");
